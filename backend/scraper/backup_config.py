# backup_config.py
#  BACKUP DE SCURIT - Configuration complte ASCR Handball
# Ne pas modifier ce fichier ! Il sert de sauvegarde.
...
if __name__ == "__main__":
    print(" Configuration de backup ASCR Handball")
    print(f"[INFO] {len(BASE_URLS_BACKUP)} comptitions sauvegardes")
    print("\nPour restaurer config.py, copiez BASE_URLS_BACKUP vers BASE_URLS dans config.py")
